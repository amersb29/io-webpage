            ...
            <b-form @submit.prevent="signUp" class="flexForm">
                ...
                <span>
                    <b-form-group id="country"
                        ...
                        <CountriesSelect name="country_id" onlyCountries v-model="user.country_id" :state="true"/>
                    </b-form-group>
                </span>
                <ValidationProvider
                        v-slot="{ errors, valid }"
                ...
                <div class="auth-button-container sign-up">
                    <b-button type="submit" variant="danger" v-show="valid && passwordValidation.valid">Registrarme</b-button>
                </div>
            </b-form>
        </ValidationObserver>
    </div>
